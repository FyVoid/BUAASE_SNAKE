...
BATCH_SIZE = 64         # Number of experiences to sample for learning
GAMMA = 0.95             # Discount factor for future rewards
EPS_START = 1.0          # Starting value of epsilon (exploration rate)
EPS_END = 0.25           # Minimum value of epsilon
EPS_DECAY = 4000         # Controls the rate of exponential decay of epsilon
LR = 5e-4                # Learning rate for the optimizer
TARGET_UPDATE_FREQ = 1000  # How often to update the target network (in steps or episodes) - using steps here
